// components/AnalyticsTab.js (updated - adds PDF export)
'use client'
...
export default function AnalyticsTab({ hotelId }) {
  ...
  async function handleExport() {
    setExporting(true)
    try {
      const url = `/api/export?hotelId=${hotelId}&month=${exportMonth}`
  ...
  const heatmap = [
    [20,35,45,8],[22,38,42,9],[25,52,58,14],[28,65,72,18],[32,70,80,22],[40,75,68,35],[38,60,50,20]
  ]
  ...
  return (
    <div className="scrollable" style={{ padding:'14px',background:'var(--gray-50)',fontFamily:'var(--font)' }}>
